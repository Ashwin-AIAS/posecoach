  ...
  return (
    <label className="flex items-center gap-1.5 text-xs text-gray-400">
      ...
      <select
        ...
        aria-label="Division"
        className="rounded-full border border-surface-hairline bg-surface-raised px-3 py-1 text-xs font-medium text-gray-200 outline-none transition hover:border-accent/50 focus:border-accent disabled:opacity-50"
